...
vulkan:
	...
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-eval ds4-agent \
		CORE_OBJS="ds4.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_vulkan.o vulkan/q8_aligned_artifact.o vulkan/execution_artifact.o ds4_layer_pack.o" \
...
ds4_vulkan.o: vulkan/vulkan_backend.cpp vulkan/q8_aligned_artifact.h vulkan/execution_artifact.h vulkan/shaders/matmul_q8_0_aligned.comp vulkan/shaders/matmul_q8_0_exec.comp ds4_gpu.h ds4_vulkan.h vulkan/include/volk.h vulkan/include/vulkan/vulkan.h vulkan/include/vk_mem_alloc.h vulkan/_stubs.gen.cpp vulkan/_impl_gen.cpp vulkan/gen_impl.py
...
vulkan/execution_artifact.o: vulkan/execution_artifact.cpp vulkan/execution_artifact.h
	$(VULKAN_CXX) $(VULKAN_CXXFLAGS) -c -o $@ vulkan/execution_artifact.cpp
