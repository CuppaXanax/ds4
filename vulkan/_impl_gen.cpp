...
int ds4_gpu_compressor_prefill_tensor(ds4_gpu_tensor       *comp_cache,
        ds4_gpu_tensor       *state_kv,
        ds4_gpu_tensor       *state_score,
        const ds4_gpu_tensor *kv,
        const ds4_gpu_tensor *sc,
        ...
        float                   beta_slow,
        float                   rms_eps) { return 1; }
int ds4_gpu_compressor_store_batch_tensor(const ds4_gpu_tensor *kv,
        const ds4_gpu_tensor *sc,
        ds4_gpu_tensor       *state_kv,
        ds4_gpu_tensor       *state_score,
        const void             *model_map,
        ...
        uint32_t                pos0,
        uint32_t                n_tokens) { return 1; }
int ds4_gpu_compressor_update_tensor(const ds4_gpu_tensor *kv_cur,
        ...
        float                   beta_slow,
        float                   rms_eps,
        bool                    state_already_stored) { return 1; }
...
int ds4_gpu_shared_mid_swiglu_q8_0_tensor(ds4_gpu_tensor       *mid,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                gate_offset,
        uint64_t                up_offset,
